...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // ✅ PERBAIKAN: Navigasi ke ProfileScreen dengan param untuk trigger refresh
      navigation.navigate('ProfileStack' as any, {
        screen: 'Profile',
        params: {
          fromLogin: true, // ✅ BARU: Flag untuk indicate fresh login
          timestamp: new Date().toISOString(),
          forceRefresh: true, // ✅ BARU: Force ProfileScreen refresh
        }
      });
    ...
    try {
      ...
      if (result.success) {
        ...
        if (tokenResult.success && tokenResult.token) {
          ...
          // ✅ AUTO REFRESH: Trigger auth data reload untuk auto-login
          await loadAuthData();
