...
export default function DashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      {/* Orders Summary - DIUBAH: Grid 2 menyamping seperti feature grid */}
...
const styles = StyleSheet.create({
  ...
  // ✅ DIUBAH: Orders Grid sama persis seperti Feature Grid
  ordersGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    justifyContent: 'space-between',
  },
  // ✅ DIUBAH: Order Card sama persis seperti Feature Button
  orderCard: {
    width: '48%',
    backgroundColor: colors.background,
    padding: 16,
