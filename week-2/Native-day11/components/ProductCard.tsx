...
interface Props {
  product: Product;
  onPress?: (product: Product) => void; // Tambah prop untuk navigation
}
...
export default function ProductCard({ product, onPress }: Props) {
  ...
  // SEMUA PRODUCT CARD PAKAI WARNA SAMA - HIJAU MUDA
  const cardStyle = { 
  ...
  return (
    ...
    >
      ...
      <View style={styles.info}>
        ...
        {/* ✅ DESKRIPSI DIHAPUS DARI PRODUCT CARD */}
