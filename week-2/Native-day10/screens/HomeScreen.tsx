...
import { HomeTopTabParamList, Product } from '../navigation/types';
...
const createTabWrapper = (Component: React.ComponentType<{ products: Product[] }>, products: Product[]) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Tab.Screen 
          name="Popular" 
          component={createTabWrapper(PopularTab, dummyProducts.popular)} 
          options={{ title: 'Populer' }} 
        />
        <Tab.Screen 
          name="New" 
          component={createTabWrapper(NewTab, dummyProducts.new)} 
          options={{ title: 'Terbaru' }} 
        />
        <Tab.Screen 
          name="Discount" 
          component={createTabWrapper(DiscountTab, dummyProducts.discount)} 
          options={{ title: 'Diskon' }} 
        />
        <Tab.Screen 
          name="Electronics" 
          component={createTabWrapper(ElectronicsTab, dummyProducts.electronics)} 
          options={{ title: 'Elektronik' }} 
        />
        <Tab.Screen 
          name="Clothing" 
          component={createTabWrapper(ClothingTab, dummyProducts.clothing)} 
          options={{ title: 'Pakaian' }} 
        />
        <Tab.Screen 
          name="Food" 
          component={createTabWrapper(FoodTab, dummyProducts.food)} 
          options={{ title: 'Makanan' }} 
        />
        <Tab.Screen 
          name="Automotive" 
          component={createTabWrapper(AutomotiveTab, dummyProducts.automotive)} 
          options={{ title: 'Otomotif' }} 
        />
        <Tab.Screen 
          name="Entertainment" 
          component={createTabWrapper(EntertainmentTab, dummyProducts.entertainment)} 
          options={{ title: 'Hiburan' }} 
        />
        <Tab.Screen 
          name="Baby" 
          component={createTabWrapper(BabyTab, dummyProducts.baby)} 
          options={{ title: 'Bayi' }} 
        />
      </Tab.Navigator>
    </View>
