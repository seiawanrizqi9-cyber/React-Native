  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitleCenter}>Ringkasan Pesanan</Text> {/* GUNAKAN STYLE BARU */}
      ...
      {/* Progress Bar */}
      <View style={styles.section}>
        <Text style={styles.sectionTitleCenter}>Progress Mingguan</Text> {/* GUNAKAN STYLE BARU */}
      ...
      {/* Top Products */}
      <View style={styles.section}>
        <Text style={styles.sectionTitleCenter}>Produk Terlaris</Text> {/* GUNAKAN STYLE BARU */}
...
const styles = StyleSheet.create({
  ...
  // TAMBAHKAN STYLE BARU UNTUK TEXT CENTER
  sectionTitleCenter: {
    fontSize: 18,
    fontWeight: 'bold',
    color: colors.text,
    marginBottom: 16,
    textAlign: 'center', // ✅ STYLE TERPISAH UNTUK TEXT CENTER
  },
  ordersGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
