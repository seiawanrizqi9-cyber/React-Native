...
import { getAllProducts } from '../data/dummyProducts'; // IMPORT KEMBALI
...
export default function ProductListScreen() {
  ...
  const loadProducts = useCallback(async () => {
    try {
      ...
      // SIMULASI ERROR - 50% chance error, 50% success
      ...
      // JIKA BERHASIL - load data produk
  ...
  // Load products saat pertama kali
  useEffect(() => {
    loadProducts();
  }, [loadProducts]);
  ...
  // TAMPILKAN ERROR SCREEN JIKA ERROR
  if (error) {
    return (
      <RetryErrorScreen
        errorMessage={error}
    ...
    return (
      <View style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Memuat produk... (6 detik)</Text>
        </View>
      </View>
    );
  }
