...
// 🆕 USER INTERFACE UNTUK TYPE SAFETY
interface UserData {
  name: string;
  email: string;
  phone?: string;
...
export default function ProfileScreen() {
  ...
  const handleLoginPress = () => {
    ...
    if (parent) {
      // 🆕 NAVIGATE DENGAN CALLBACK UNTUK REFRESH
      parent.navigate('Login', { 
        onLoginSuccess: () => {
          console.log('✅ Login success callback - refresh profile');
          loadAuthData();
        }
      });
    } else {
