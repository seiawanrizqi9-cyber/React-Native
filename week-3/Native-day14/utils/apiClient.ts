...
import { ValidationError } from './validationError'; // IMPORT BARU
...
// RESPONSE INTERCEPTOR BARU UNTUK VALIDATION ERRORS
...
export const API_ENDPOINTS = {
  ...
  CHECKOUT: '/checkout', // ENDPOINT BARU UNTUK SIMULASI
} as const;
